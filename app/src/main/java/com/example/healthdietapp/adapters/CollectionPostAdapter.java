...
/**
 * CollectionPostAdapter - Adapter for displaying collected posts
 */
public class CollectionPostAdapter extends RecyclerView.Adapter<CollectionPostAdapter.PostViewHolder> {
    ...
    public CollectionPostAdapter(OnPostClickListener listener) {
