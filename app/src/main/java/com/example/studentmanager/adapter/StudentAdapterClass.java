 ...
 * 学生列表适配器
 */
public class StudentAdapterClass extends RecyclerView.Adapter<StudentAdapterClass.StudentViewHolder> {
    ...
    public StudentAdapterClass(Context context, List<Student> studentList) {
