...
public class BookAdapter extends RecyclerView.Adapter<BookAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // 添加购买按钮点击事件
        holder.tvBookPurchase.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (onItemClickListener != null) {
                    onItemClickListener.onItemPurchaseClick(holder.getAdapterPosition(), book);
                }
            }
        });
    }
    ...
    public interface OnItemClickListener {
        ...
        void onItemPurchaseClick(int position, Book book);
    }
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public TextView tvBookName, tvBookAuthor, tvBookDesc, tvBookNum, tvBookDetail, tvBookBorrow, tvBookPurchase;
        ...
        public ViewHolder(View itemView) {
            ...
            tvBookPurchase = itemView.findViewById(R.id.tv_book_purchase);
        }
    }
}
