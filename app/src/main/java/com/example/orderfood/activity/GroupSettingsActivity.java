...
public class GroupSettingsActivity extends AppCompatActivity implements GroupMemberAdapter.OnRemoveMemberClickListener {
    ...
    private void setupListeners() {
        btnAddMembers.setOnClickListener(v -> {
            Intent intent = new Intent(GroupSettingsActivity.this, AddMembersActivity.class);
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("确定", (dialog, which) -> {
                    if (isCreator) {
                        ...
                        Toast.makeText(GroupSettingsActivity.this, "群聊已解散", Toast.LENGTH_SHORT).show();
                    } else {
                        dbHelper.removeGroupMember(groupId, currentUserId);
                        Toast.makeText(GroupSettingsActivity.this, "已退出群聊", Toast.LENGTH_SHORT).show();
                    }
    ...
    public void onRemoveMember(User member) {
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("移除", (dialog, which) -> {
                    ...
                    Toast.makeText(GroupSettingsActivity.this, member.getNickname() + " 已被移出群聊", Toast.LENGTH_SHORT).show();
                    refreshMemberList();
                })
                .setNegativeButton("取消", null)
                .show();
