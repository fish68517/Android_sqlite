...
class ChatAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MessageViewHolder {
        ...
        val view = when (viewType) {
            VIEW_TYPE_SENT -> inflater.inflate(R.layout.item_message_sent, parent, false)
            VIEW_TYPE_RECEIVED -> inflater.inflate(R.layout.item_message_received, parent, false)
    ...
    class MessageViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(message: Message, position: Int, listener: OnMessageLongClickListener, viewType: Int) {
