...
public class DataBaseOpenHelper extends SQLiteOpenHelper {
    ...
    private static final String COLUMN_FK_USER_ID = "user_id";
    private static final String COLUMN_FK_CONTACT_USER_ID = "contact_user_id";
    private static final String COLUMN_REMARK_NAME = "remark_name";
    ...
    public static final String COLUMN_GROUP_ID = "group_id"; // Added for messages
    ...
    private static final String COLUMN_DELETED_MSG_ID = "message_id";
    private static final String COLUMN_DELETED_USER_ID = "user_id";
    ...
    private static final String COLUMN_GROUP_CREATED_AT = "created_at";

    // Group members table
    private static final String TABLE_GROUP_MEMBERS = "group_members";
    private static final String COLUMN_GM_GROUP_ID = "group_id";
    private static final String COLUMN_GM_USER_ID = "user_id";
    ...
    private void addDummyData(SQLiteDatabase db) {
        addUser(db, "周杰伦", "123", "周杰伦");
        addUser(db, "林俊杰", "123", "林俊杰");
        addUser(db, "李荣浩", "123", "李荣浩");
        addUser(db, "王菲", "123", "王菲");
        addUser(db, "刘德华", "123", "刘德华");
    ...
    private boolean isContact(int userId, int potentialContactId) {
        SQLiteDatabase db = this.getReadableDatabase();
